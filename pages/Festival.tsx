...
const yakinikuBrands: BrandEntry[] = [
  ...
  { name: '燒肉眾', category: '燒肉名店', logo: '/festival/brand-sioumazang.jpg', desc: '主打日式燒肉的人氣品牌，肉品部位多元、油花講究，強調炭火直烤的香氣與火候。從經典牛五花到精選部位一應俱全，搭配清爽小菜與時蔬。以親切服務與穩定品質累積口碑，適合三五好友與家庭聚餐。' },
  { name: '狸小路燒肉', category: '日式燒肉', logo: '/festival/brand-tanukikoji.png', desc: '以日式燒肉為主軸，帶出北海道商店街意象的用餐氛圍，主打道地炭火燒肉體驗。精選牛豬部位與海鮮，佐以日式醬料與鹽味吃法，讓食客自烤自享。份量實在、氛圍溫暖，適合朋友小聚與下班聚餐。' },
  { name: '延香炭食', category: '炭火燒肉', logo: '/festival/brand-yanxiang.jpg', desc: '以炭火燒肉為核心，強調炭烤帶出的焦香與鎖住的肉汁。菜單涵蓋牛豬雞與海鮮多元選擇，搭配自家醬料與時蔬，講究炭火溫度掌握。氛圍適合聚餐與小酌，是喜歡炭香風味者的選擇。' },
  { name: '老井極上燒肉', category: '極上和牛', logo: '/festival/brand-laojin.png', desc: '定位高端的和牛燒肉，主打「極上」等級的和牛部位，油花細緻、入口即化。以稀有部位與講究的燒烤呈現和牛層次，搭配專業桌邊服務。適合追求頂級肉質的饕客與重要場合的宴請。' },
  { name: '一鷺燒肉', category: '日式燒肉', logo: '/festival/brand-ichiro.jpg', desc: '日式燒肉品牌，主打精選肉品與職人炭火燒烤，講究部位處理與醬料搭配。從牛五花、橫膈膜到特選部位，品味不同口感層次。用餐環境舒適，適合聚餐與約會。' },
  { name: '焦糖楓', category: '燒肉名店', logo: '/festival/brand-maple.jpg', desc: '以燒肉為主的名店，營造溫暖質感的用餐氛圍，主打多元肉品與細膩的燒烤體驗。菜單搭配時令食材與特色醬料，兼顧經典與創意，適合聚餐與紀念日場合。' },
  { name: '烤烤豬', category: '日式燒肉', logo: '/festival/brand-kaokao.jpg', desc: '以豬肉燒烤為特色的日式燒肉品牌，主打各式豬肉部位的鮮甜與炭火香。菜單平易近人、份量充足，適合家庭與朋友輕鬆聚餐，以親民定位與穩定品質受到喜愛。' },
  { name: '炭伙居酒屋', category: '燒肉名店', logo: '/festival/brand-tankaho.jpg', desc: '結合炭火燒肉與居酒屋風格，主打炭烤料理搭配清酒與啤酒，營造熱鬧的居酒屋氛圍。除燒肉外亦有多樣下酒小食，適合下班小酌與朋友聚會。' },
  { name: '純水燒肉', category: '燒肉名店', logo: '/festival/brand-chunshui.jpg', desc: '以燒肉為主，訴求純粹乾淨的用餐體驗，主打嚴選肉品與清爽搭配。菜單著重食材本味，佐以簡約醬料與時蔬。氛圍舒適，適合聚餐與家庭用餐。' },
  { name: '一頭牛日式燒肉', category: '日式燒肉', logo: '/festival/brand-yitouniu.png', desc: '以「一頭牛」為概念的日式燒肉，主打從牛隻不同部位完整品嚐，一次體驗多樣口感與油花層次。強調食材新鮮與部位分切的專業，適合喜愛牛肉的族群與聚餐。' },
  { name: 'Char Char Steak & Bar', category: '牛排酒吧', logo: '/festival/brand-charchar.jpg', desc: '結合牛排與酒吧的複合品牌，主打炙烤牛排搭配調酒與紅白酒，營造精緻又放鬆的氛圍。適合約會、慶祝與商務小酌，將排餐與微醺體驗結合於一店。' },
  { name: '燒肉smile', category: '日式燒肉', logo: '/festival/brand-smile.jpeg', desc: '以歡樂用餐氛圍為訴求的日式燒肉，主打多元肉品與親切服務，讓聚餐充滿笑容。菜單平易近人、選擇豐富，適合家庭、朋友與各種聚會場合。' },
  { name: '大河屋', category: '日式燒肉', logo: '/festival/brand-dahewu.png', desc: '日式風格的燒肉品牌，主打炭火燒肉與日式定食氛圍，選材講究、醬燒入味。菜單兼具燒肉與日式料理元素，適合喜愛日式風味的食客聚餐。' },
  { name: '八色烤肉mini', category: '韓式烤肉', logo: '/festival/brand-basei.png', desc: '源自韓國的人氣韓式烤肉品牌，招牌為八種口味的調味豬五花，一次品嚐多層次風味。搭配韓式小菜與生菜包肉的道地吃法，氛圍熱鬧；mini 店型更貼近日常聚餐，適合朋友與家庭。' },
  { name: '精誠壹山燒肉', category: '燒肉名店', logo: '/festival/brand-yishan.jpeg', desc: '主打精選燒肉的名店，強調肉品品質與炭火燒烤的香氣層次。菜單涵蓋牛豬海鮮多元部位，搭配講究的醬料與服務，氛圍適合聚餐與宴客。' },
  { name: '脂本燒肉', category: '燒肉名店', logo: '/festival/brand-zhiben.jpeg', desc: '以「脂」為名、講究油花的燒肉品牌，主打油脂分布均勻的精選肉品，凸顯燒肉入口的甘甜與香氣。重視部位挑選與燒烤呈現，適合追求肉質風味的食客。' },
  ...
  { name: '吃肉肉', category: '燒肉吃到飽', logo: '/festival/燒肉logo/吃肉肉logo.png', desc: '主打燒肉吃到飽，肉品與配菜選擇豐富、一價暢享，滿足大食量與多人聚餐需求。氛圍輕鬆熱鬧，適合家庭、學生與朋友聚會，走高 CP 值取向。' },
  { name: '油花', category: '迴轉燒肉', logo: '/festival/燒肉logo/油花迴轉吧燒肉logo.jpg', desc: '以「迴轉燒肉」為特色的創新品牌，將燒肉結合迴轉台形式，隨取隨烤、新鮮有趣。肉品部位多元、單點靈活，適合想輕鬆嚐鮮與朋友同樂的場合。' },
  // ─── 移至最後 ───
  { name: '燒肉來1喀', category: '燒肉名店', logo: '/festival/brand-laika.jpg', desc: '主打輕鬆「一口一喀」燒肉體驗的名店，肉品切片與份量便於分享，適合三五好友邊烤邊聊。菜單多元、氛圍熱絡，是聚餐小酌的選擇之一。' }
];

// 火鍋品牌：logo 放入 public/festival/火鍋logo/ 後加到此陣列
const hotpotBrands: BrandEntry[] = [
  { name: '千葉火鍋', category: '涮涮鍋', logo: '/festival/brand-chiba.webp', desc: '老字號涮涮鍋品牌，以自助吃到飽形式著稱，肉品、海鮮與蔬菜自助吧選擇豐富。湯頭清爽、平價實惠，適合家庭聚餐與多人共食，以熱鬧氛圍與豐富選擇成為連鎖火鍋的常見選擇。' },
  { name: '雞湯大叔', category: '雞湯鍋', logo: '/festival/brand-jitangdashu.jpg', desc: '主打雞湯鍋物，湯底以雞骨長時間熬煮，濃郁甘醇、暖心暖胃。搭配新鮮肉品、海鮮與火鍋料，適合注重湯頭與養生的食客，氛圍溫馨，適合家庭與朋友聚餐。' },
  ...
  { name: '賴山嶼', category: '鍋物', logo: '/festival/brand-laishanyu.jpeg', desc: '主打精緻鍋物，講究湯頭與食材搭配，呈現細膩的個人鍋或分享鍋體驗。選材新鮮、擺盤用心，適合想安靜享受鍋物的聚餐與約會場合。' },
  ...
  { name: '二本松涮涮屋', category: '涮涮鍋', logo: '/festival/brand-nihonmatsu.jpg', desc: '日式風格的涮涮鍋品牌，主打清爽湯頭與新鮮肉片，透過「涮」的方式保留食材原味。搭配日式沾醬與時蔬，用餐氛圍清新，適合注重食材本味的食客。' },
  { name: '橋山壽喜燒', category: '壽喜燒', logo: '/festival/brand-hashiyama.jpg', desc: '專營日式壽喜燒，以甜鹹交融的醬汁湯底搭配薄切肉片與蔬菜，佐以生蛋液沾裹，呈現道地日式風味。氛圍溫潤，適合喜愛日式鍋物的食客與聚餐。' },
  { name: '祇園禪院壽喜燒', category: '壽喜燒', logo: '/festival/brand-gion.jpg', desc: '以京都「祇園」意象打造的壽喜燒品牌，主打日式禪意用餐氛圍與講究的壽喜燒體驗。精選肉品搭配甜鹹醬汁與生蛋沾裹、慢火細煮，適合約會與講究氛圍的聚餐。' },
  { name: '川鳳港式麻辣雞煲火鍋', category: '港式火鍋', logo: '/festival/brand-chuanfeng.jpg', desc: '結合港式雞煲與麻辣風味，先吃香辣入味的雞煲、再加湯轉為火鍋涮煮，一鍋兩吃。川味底湯搭配台灣土雞，辣得有層次、回甘有勁，適合嗜辣與喜愛港式風味的食客。' },
  { name: '百味釜精緻鍋物', category: '精緻鍋物', logo: '/festival/brand-baiweiku.jpg', desc: '主打精緻個人鍋物，湯頭選擇多元、擺盤講究，將世界料理元素融入鍋物。適合想在舒適環境細細品味的食客，聚餐與約會皆宜。' },
  { name: '老東家重慶麻辣鍋', category: '麻辣鍋', logo: '/festival/brand-laodongja.jpg', desc: '主打重慶風味的麻辣鍋，湯底以多種辛香料與辣椒、花椒熬煮，麻辣濃香、層次分明。搭配鴨血、豆腐與各式肉品，適合嗜辣與喜愛重口味鍋物的食客。' },
  { name: '草原風蒙古火鍋', category: '蒙古火鍋', logo: '/festival/brand-caoyuan.jpg', desc: '以蒙古風味為特色的火鍋，湯底融合多種辛香與藥膳，搭配羊肉、牛肉等肉品，帶出草原料理的豪邁風味。適合喜愛特色湯頭與羊肉鍋物的食客聚餐。' },
  { name: '米釉鍋物', category: '精緻鍋物', logo: '/festival/brand-miyou.jpg', desc: '定位精緻的鍋物品牌，講究湯頭熬製與食材品質，呈現細膩的個人鍋體驗。擺盤與環境用心，適合想安靜享用高質感鍋物的食客與約會場合。' },
  { name: '潮牛殿', category: '潮汕鍋物', logo: '/festival/brand-chaoniudian.jpg', desc: '主打潮汕牛肉鍋，以清甜牛骨湯底涮煮現切牛肉不同部位，講究刀工與涮煮時間，佐以沙茶醬品嚐。適合喜愛新鮮牛肉與潮汕吃法的食客。' },
  { name: '聚食釜', category: '精緻鍋物', logo: '/festival/brand-jushifu.jpg', desc: '主打一人一釜的精緻個人鍋物，把家的溫度做成單人份的儀式感。湯頭與食材講究，適合單獨用餐或朋友各享一鍋，環境舒適、氛圍溫馨。' },
  { name: '老井麻神', category: '鍋物', logo: '/festival/brand-laojin-mashen.jpg', desc: '主打麻辣風味的鍋物，湯底講究麻與辣的平衡，香氣濃郁、順口耐吃。搭配多樣火鍋料與肉品，適合嗜辣與喜愛濃郁湯頭的食客聚餐。' },
  { name: '尚石苑', category: '精緻鍋物', logo: '/festival/brand-shangshiyuan.jpg', desc: '定位精緻的鍋物品牌，講究湯頭與食材呈現，營造沉穩雅致的用餐氛圍。選材用心、服務細膩，適合商務宴請與重要場合。' },
  { name: '徐泰山汕頭火鍋', category: '汕頭鍋物', logo: '/festival/brand-xutaishan.png', desc: '主打汕頭沙茶火鍋，以牛肉與沙茶醬為靈魂，湯底清甜、涮煮現切牛肉，佐以獨門沙茶提味，呈現道地潮汕吃法，適合喜愛牛肉鍋與沙茶風味者。' },
  { name: '今之旬', category: '鍋物', logo: '/festival/brand-jinzhixun.png', desc: '以「當令當旬」為概念的鍋物品牌，強調使用時令新鮮食材，湯頭清爽帶出食材本味。擺盤精緻、講究季節感，適合注重新鮮與品質的食客。' },
  { name: '百年土種蔘雞湯', category: '雞湯鍋', logo: '/festival/brand-bainian.png', desc: '主打人蔘雞湯，以土種雞與人蔘、藥膳長時間熬煮，湯頭滋補濃醇、暖身暖胃，呈現藥膳雞湯風味，適合注重養生與喜愛雞湯鍋物的食客。' },
  { name: '鍋泰暖', category: '鍋物', logo: '/festival/brand-guotainan.png', desc: '主打暖心湯頭的鍋物品牌，講究湯底熬製與食材搭配，呈現溫潤順口的鍋物體驗。適合家庭與朋友在舒適環境中聚餐暖胃。' },
  { name: '聰明鍋', category: '鍋物', logo: '/festival/火鍋logo/聰明鍋logo.jpeg', desc: '主打鍋物的品牌，以聰明的食材搭配與湯頭設計為訴求，讓用餐兼顧美味與均衡。菜單選擇多元、平易近人，適合日常聚餐與家庭用餐。' },
  { name: '李鐵柱', category: '麻辣燙', logo: '/festival/火鍋logo/李鐵柱logo.jpeg', desc: '主打麻辣燙，讓食客自選食材、以麻辣湯底汆燙後盛碗享用，一人也能輕鬆吃。辣香夠味、選擇自由，適合快速用餐與嗜辣族群。' },
  { name: '蘇記嘀兜雞', category: '雞煲', logo: '/festival/火鍋logo/蘇記嘀兜雞logo.jpeg', desc: '主打雞煲，以特製醬汁與辛香料燜煮雞肉，先吃香濃雞煲、再加湯轉火鍋涮煮，一鍋雙享。風味濃郁下飯，適合喜愛雞煲與火鍋的食客聚餐。' },
  { name: '荖子鍋', category: '鍋物', logo: '/festival/火鍋logo/荖子鍋logo.jpg', desc: '主打特色鍋物，講究湯頭與食材搭配，呈現順口暖胃的鍋物體驗。選材用心、環境舒適，適合家庭與朋友聚餐。' },
  { name: '金蒔鍋物', category: '精緻鍋物', logo: '/festival/火鍋logo/金蒔鍋物logo.png', desc: '定位精緻的鍋物品牌，講究湯底與食材品質，擺盤與環境雅致，呈現細膩的個人鍋或分享鍋。適合想在質感空間享用鍋物的食客與宴客場合。' },
  { name: '六松今苑', category: '壽喜燒', logo: '/festival/火鍋logo/六松今苑logo.jpeg', desc: '主打日式壽喜燒，以甜鹹醬汁湯底涮煮薄切肉片與蔬菜，佐以生蛋沾裹，呈現道地壽喜燒風味。用餐氛圍雅致，適合喜愛日式鍋物與講究氛圍的食客。' }
];
